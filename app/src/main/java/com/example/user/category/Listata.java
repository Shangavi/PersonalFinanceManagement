    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        listItemText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(context, subCategory_income.class); //Redirecting to another activity
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    SQLiteDatabase db = new DatabaseOperator(context.getApplicationContext()).
                                            getWritableDatabase();
                                    db.delete(DatabaseOperator.categoryIncone_table_name, DatabaseOperator.CategoryIncome_ID +
